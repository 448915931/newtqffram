package com.tqfframe.datamanage.client;

import com.tqfframe.datamanage.client.fallback.UserClientHystix;
...
public interface UserClient {
    ...
    String userClickTimeOut(@PathVariable(name = "userid") String userid);
